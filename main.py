...
# Form implementation generated from reading ui file 'choose_win.ui'
#
...
"    border-radius: 10px;")
        ...
        self.area_label.setGeometry(QtCore.QRect(540, 180, 391, 71))
        font2 = QtGui.QFont()
        font2.setPointSize(20)
        font2.setBold(True)
        font2.setWeight(75)
        self.area_label.setFont(font2)
        self.area_label.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.area_label.setStyleSheet("background-color: white;\n"
" border: 4px solid black;")
        ...
        self.scope_label = QtWidgets.QLabel(self.centralwidget)
        self.scope_label.setGeometry(QtCore.QRect(540, 280, 391, 71))
        font2 = QtGui.QFont()
        font2.setPointSize(20)
        font2.setBold(True)
        font2.setWeight(75)
        self.scope_label.setFont(font2)
        self.scope_label.setStyleSheet("background-color: white;\n"
" border: 4px solid black;")
        self.scope_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.scope_label.setObjectName("scope_label")
        self.diagonals_label = QtWidgets.QLabel(self.centralwidget)
        self.diagonals_label.setGeometry(QtCore.QRect(540, 380, 391, 71))
        font2 = QtGui.QFont()
        font2.setPointSize(20)
        font2.setBold(True)
        font2.setWeight(75)
        self.diagonals_label.setFont(font2 )
        self.diagonals_label.setStyleSheet("background-color: white;\n"
" border: 4px solid black;")
        self.diagonals_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
...
"                             }")
        ...
        self.square_labels = [self.Back_Button, self.square_title ,self.square_Photo2, self.squareRib_input, self.area_label, self.diagonals_label, self.scope_label, self.pushButton_submitSquare]
        self.traingle_labels = []
    ...
    def retranslateUi(self, choose_Shape):
        ...
        self.area_label.setText(_translate("choose_Shape", "Area(Square cm): "))
        self.scope_label.setText(_translate("choose_Shape", "Scope(cm): "))
        self.diagonals_label.setText(_translate("choose_Shape", "Diagonals Length: "))
    ...
    def square_submit(self):
        try:
            ...
            self.area_label.setText(f"Area(Square cm): {str(area)}")
            self.scope_label.setText(f"Scope(cm): {str(scope)}")
            self.diagonals_label.setText(f"Diagonals Length: {str(diagonal)}")
        except ValueError:
            error = QMessageBox()
